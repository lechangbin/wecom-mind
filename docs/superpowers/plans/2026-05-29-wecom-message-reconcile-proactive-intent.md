...
- The current proactive scan helper selects by `chatid` and filters the time window in Python. This should be changed to a SQL time-window query before production-like polling.
